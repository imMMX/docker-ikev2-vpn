...
iptables -A FORWARD --match policy --pol ipsec --dir in --proto esp -s 10.10.1.0/24 -j ACCEPT
iptables -A FORWARD --match policy --pol ipsec --dir out --proto esp -d 10.10.1.0/24 -j ACCEPT
iptables -t nat -A POSTROUTING -s 10.10.1.0/24 -m policy --pol ipsec --dir out -j ACCEPT
